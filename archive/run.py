...
def play(env, n_round, handles, models, print_every, eps=1.0, render=False, train=False, cuda=False):
    """play a ground and train"""
    env.reset()

    max_steps = env.num_periods
    step_ct = 0
    done = False
    ...
    n_action = [env.get_num(handle) for handle in handles] #TODO: check this line
