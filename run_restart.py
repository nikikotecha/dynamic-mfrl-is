...
def load_data(path, name, networks):
    """
...
if __name__ == "__main__":
    ...
    args_, explore_params, episode_trained, time_trained, outcome=load_data(file_path, file_num, networks)
    ...
    print("explore_params: ", explore_params)
    epsilon = explore_params['epsilon']
    beta = explore_params['beta']
    ...
    for i in range(args.num_episodes):
        ...
        #print("explore_params: ", explore_params)
        #print("After loading:", networks.actor_opt[0].state_dict())   # Should be different if loaded successfully
        #print("After loading:", networks.actor[0].state_dict())  # Print initial state
